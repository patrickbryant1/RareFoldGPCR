...
from rarefold.model.tf import shape_helpers
from rarefold.model.tf import shape_placeholders
from rarefold.model.tf import utils
import numpy as np
...
def make_msa_feat(protein):
  ...
  aatype_1hot = tf.one_hot(protein['aatype'], residue_constants.restype_num, axis=-1)
...
def make_atom14_masks(protein):
  ...
  # Add dummy mapping for restype 'UNK' - alredy taken care of by using UNK
